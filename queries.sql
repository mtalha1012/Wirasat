...
-- View: Get Latest Asset Valuations
...
BEGIN
    ...
    -- Output Alive Heirs List (Returns as a second result set)
    SELECT 
        dh.heir_id, 
        fm.name, 
        fm.gender, 
